...
function StoreStockData(irisNative){
    ...
    console.log("One sample stock data is as follows:\n" + array[1]);
...
function PopulateData(irisNative, object_count)
	{
		...
		for(var i = 0; i < object_count; i++){
            ...
            console.log("New trade: " + tempName + ", " + tempDate + ", " + tempAmoun5t + ", " + tempShares + ", " + tempTrader);
        }
    }

// Call routine directly to print the version of InterSystems IRIS.    
function callRoutines(irisNative){
    console.log("on InterSystems IRIS version:\n" + irisNative.function("StocksUtil", "PrintVersion"))
}
